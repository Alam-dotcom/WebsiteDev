...
<body>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown active" onmouseover="showDropdownMenu(this)"
                            ...
                            <div class="dropdown-menu" aria-labelledby="eventsDropdown">
                                ...
                                <a class="dropdown-item active" href="services-corporate.php">Corporate Events</a>
    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                ...
                The corporate world is fast-paced and full of details. When partnering with  Elite Event Planners,
            we take care of those details
            while creating a unique experience for your guests that coincides with your company’s vision. </p> <br>
            <p style="text-align:justify"> 
            Whether it’s attracting new customers, educating your employees, or celebrating company milestones, we’ll
            ...
            from the production to design, your Elite team will bring your brand to 
            life through our high quality planning and management services, as well as day-of coordination.</p>
                </div>
                <div class="col-lg-5">
                <img src="https://hire4event.com/blogs/wp-content/uploads/2019/07/Corporate-Event-Planning.jpg" alt="" width="" class="img-fluid"/>
                </div>
            </div>
        </div>
    </div><br><br>
    ...
    <div class="container">
        <div class="row" style="background-color:#ED9834">
            ...
            <img src="https://files.sysers.com/cp/upload/tneventspc/gallery/full/Corporate-Event-Planner.jpg" alt="" height="300px" width="300px" />
            </div>
            <div class="col-md-5 p-4">
            <h4 style="color:white">EVENT SERVICES</h4><br>
            <ul>
                        <li><b>On-site Coordination and Management</b></li>
                        <li><b>Meeting Planning</b></li>
                        <li><b>Brand Integration</b></li>
                        <li><b>Rentals and Vendor Coordination</b></li>
                        <li><b>Floor plan Design</b></li>
                        <li><b>Budget Management</b></li>
                        <li><b>Staging</b></li>
                        <li><b>Security and Staffing</b></li>
                        <li><b>Entertainment</b></li>
                        <li><b>Transportation and Parking</b></li>
                    </ul>
            </div>
        </div>
    </div>
