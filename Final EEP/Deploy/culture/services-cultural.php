...
<body>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown active" onmouseover="showDropdownMenu(this)"
                            ...
                            <div class="dropdown-menu" aria-labelledby="eventsDropdown">
                                ...
                                <a class="dropdown-item active" href="services-cultural.php">Cultural Events</a>
                            </div>
                        </li>
    ...
    <!------------------------------------------------------------------------
     ...
     <div class="container-fluid py-3" style="background-color: #ed9834;">
        <div class="container">
            <div class="row ">
                <h2 class="text-center">Cultural Events</h2>
            </div>
        </div>
    </div><br>
    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                ...
                Culture is the heart of society. Connect with people and build communities by organising cultural events with
            Elite Event Planners. We take care of all details while creating a unique experience for your guests
             that coincides with your cultural values.</p> <br>
            <p style="text-align:justify"> 
            Whether it’s a country-based cultural event, art and craft, or celebrating cultural festivals, we’ll
            ...
            from the production to design, your Elite team will bring your vision to 
            life through our high quality planning and management services, as well as day-of coordination.</p>
                </div>
                <div class="col-lg-5">
                <img src="https://media.istockphoto.com/id/841152680/photo/business-meeting-with-word-culture-on-table.jpg?s=612x612&w=0&k=20&c=cvo-PFi9w2W9k4ZpI9SRMPKy-TLldGrn23M595yAERs=" alt="" width="" class="img-fluid"/>
                </div>
            </div>
        </div>
    </div><br><br>
        ...
        <div class="row" style="background-color:#ED9834">
            ...
            <h4 style="color:white">TYPES OF EVENTS</h4><br>
                        <ul>
                            ...
                            <li>Country-based Cultural Events</li>
                            <li>Dance and Music Events</li>
                            <li>Sports Events</li>
                            <li>Pottery and Ceramics</li>
                            <li>Prose and Poetry Events</li>
                            <li>Wood Working</li>
                            <li>Art Workshops</li>
                        </ul>
            </div>
            <div class="col-md-3 py-4">
            <img src="images/cultural-01.jpg" alt="" height="300px" width="300px" />
            </div>
