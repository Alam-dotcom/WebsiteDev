...
<head>
    ...
    <!-- External Css -->
    <link rel="stylesheet" type="text/css" href="../gatherings/abc.css">
    </link>
...
<body>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown active" onmouseover="showDropdownMenu(this)"
                            ...
                            <div class="dropdown-menu" aria-labelledby="eventsDropdown">
                                <a class="dropdown-item active" href="services-wedding.php">Weddings</a>
    ...
    <!------------------------------------------------------------------------
     ...
     <div class="container-fluid py-3" style="background-color: #ed9834;">
        <div class="container">
            <div class="row ">
                <h2 class="text-center">Wedding Events</h2>
            </div>
        </div>
    </div><br>
    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                <p style="text-align:justify">Our team is here to make the day 
                you've always dreamed of, the day you'll never forget.From the very beginning, we will create a custom proposal based on your wants and needs. Once booked, your
                 Elite event team will collaborate with you to build the foundation of your wedding, creating an
                 inspiration board and floor plan based on your unique vision. From unique lighting to seating charts, with us
                 customization is guaranteed.</p> <br>
            <p style="text-align:justify"> 
            We care about the experience of planning your wedding from start to finish. So relax and have fun. Your Elite 
                 event team will guide you every step of the way, ensuring your big day is effortless and unforgettable.</p>
                </div>
                <div class="col-lg-5">
                <img src="../images/Cimg1.jpg" alt="" class="img-fluid"/>
                </div>
            </div>
        </div>
    </div><br><br>
    ...
    <div class="container">
        <div class="row" style="background-color:#ED9834">
            ...
            <img src="https://infinityhospitalitygroup.com/wp-content/uploads/2019/07/Rachel-Nick_Bridge-Building-Wedding_11-600x400.jpg" alt="" height="300px" width="300px" />
            </div>
            <div class="col-md-5 p-4">
            <h4 style="color:white">EVENT SERVICES</h4><br>
                    <ul>
                        <li>Ceremony and Reception Coordination</li>
                        <li>Rehearsal Dinner Coordination</li>
                        <li>Wedding Day Timeline</li>
                        <li>Rentals and Vendor Coordination</li>
                        <li>Floor plan Design</li>
                        <li>Wedding Concept and Design</li>
            ...
            <div class="container">
                <div class="row" >
                    <div class="col-md-4" style="background-color:#ED9834;border-radius:5px;"> 
                        <h2 style="margin-top:0px;justify-content: center;display: flex;padding-top:20px ">Get In Touch</h2>   
                    ...
                    <h2 style="margin-top:0px;justify-content: center;display: flex;padding-top:20px">Latest Blog</h2>
                    ...
                    <div class="col-md-4" style="background-color:#ED9834;border-radius:5px;">
                    <h2 style="margin-top:0px;justify-content: center;display: flex;padding-top:20px">Visit Our Gallery</h2>
